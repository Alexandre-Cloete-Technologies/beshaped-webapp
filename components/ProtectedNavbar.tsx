            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className={`text-sm font-medium transition ${isActive ? "text-beshaped-dark-green" : "text-zinc-700 hover:text-zinc-900"
                    }`}
                >
                  {item.label}
                </Link>
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`text-base font-medium transition ${isActive ? "text-beshaped-dark-green" : "text-zinc-700 hover:text-zinc-900"
                  }`}
              >
                {item.label}
              </Link>
